...
function M.setup()
	...
	theme.highlights = {
		...
		FloatBorder = { fg = c.border, bg = c.bg_popup }, -- Float Border.
		...
		SignColumnSB = { fg = c.fg_dim, bg = c.sign }, -- Column where |signs| are displayed in the sidebar.
		...
		Pmenu = { fg = c.none, bg = c.bg_popup }, -- Popup menu: normal item.
		PmenuSel = { link = "Cursor" }, -- Popup menu: selected item.
		PmenuSbar = { fg = c.none, bg = c.cursor }, -- Popup menu: scrollbar.
		PmenuThumb = { bg = c.bg_cursor }, -- Popup menu: Thumb of the scrollbar.
		...
		StatusLine = { fg = c.fg_status_line_active, bg = c.bg_statusline }, -- Status line of current window.
		StatusLineNC = { fg = c.fg_status_line_inactive, bg = c.bg_statusline }, -- Status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use `^^^` in the status line of the current window.
		...
		RenderMarkdownSign = { fg = c.fg_dim, bg = c.bg_sidebar },
		...
		LspInfoBorder = { fg = c.border, bg = c.none },

		BlinkCmpMenu = { fg = c.border, bg = c.bg_popup },
