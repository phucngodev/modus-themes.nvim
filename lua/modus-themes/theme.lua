...
function M.setup()
	...
	theme.highlights = {
		...
		IncSearch = { fg = c.fg_main, bg = c.bg_incsearch }, -- `incsearch` highlighting; also used for the text replaced with `:s///c`.
		...
		Visual = { fg = c.fg_main, bg = c.bg_visual }, -- Visual mode selection.
		...
		TabLineFill = { fg = c.fg_main, bg = c.bg_tab_bar }, -- Tab pages line, where there are no labels.
		...
		MoreMsg = { fg = c.main, bg = c.bg_moremsg }, -- The |more-prompt|.
