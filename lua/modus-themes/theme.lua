...
function M.setup()
  ...
  theme.highlights = {
    ...
    FloatBorder = { fg = c.comment, bg = c.none }, -- Float Border.
    FloatTitle = { fg = c.none, bg = c.bg_popup }, -- Float Title.
    Folded = { fg = c.green_faint, bg = c.bg_main }, -- Line for closed folds.
    LineNr = { fg = c.bg_scollbar, bg = c.bg_main }, -- Line number for `:number` and `:#` commands, and when `number`, or `relativenumber` is set for the cursor line.
    ...
    Pmenu = { fg = c.main, bg = c.bg_menu }, -- Popup menu: normal item.
    PmenuSel = { fg = c.comment, bg = c.bg_scollbar}, -- Popup menu: selected item.
    PmenuSbar = { fg = c.none, bg = c.bg_cursor }, -- Popup menu: scrollbar.
    ...
    DiffChange = { fg = c.fg_changed, bg = c.bg_green_nuanced }, -- Diff mode: Changed line |diff.txt|.
    DiffText = { fg = c.fg_changed, bg = c.bg_yellow_intense }, -- Diff mode: Changed text within a changed line |diff.txt|.
    ...
    LazyGitBorder = { fg = c.comment, bg = c.none },

    -- Syntax
    Comment = { fg = c.comment }, -- Any comment.
    String = { fg = c.green_cooler }, -- String constant (e.g. `"this is a string"`).
    ...
    RenderMarkdownCode = { bg = c.bg_cursor },
    ...
    LspSignatureActiveParameter = { fg = c.comment, bg = c.visual },
    LspInfo = { fg = c.comment, bg = c.bg_popup },
    LspInfoBorder = { fg = c.border, bg = c.bg_popup },

    BlinkCmpMenu = { fg = c.comment, bg = c.bg_popup },
    BlinkCmpMenuBorder = { fg = c.comment, bg = c.bg_popup },
    BlinkCmpDocBorder = { fg = c.comment, bg = c.bg_popup },
    BlinkCmpDocSeparator = { fg = c.comment, bg = c.bg_popup },
    BlinkCmpSignatureHelp = { fg = c.none, bg = c.bg_popup },
    BlinkCmpSignatureHelpBorder = { fg = c.comment, bg = c.bg_popup },
    ...
    ["@tag.attribute"] = { fg = c.blue_cooler },
