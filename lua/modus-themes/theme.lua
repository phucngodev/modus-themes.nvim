...
function M.setup()
	...
	theme.highlights = {
		...
		-- Avante
		AvanteConflictCurrent = { fg = c.fg_changed, bg = c.bg_changed },
		AvanteConflictIncoming = { fg = c.fg_added, bg = c.bg_added },
		AvanteToBeDeletedWOStrikethrough = { fg = c.fg_removed, bg = c.bg_removed  },
		AvanteSidebarWinSeparator= { fg = c.border, bg = c.none },
