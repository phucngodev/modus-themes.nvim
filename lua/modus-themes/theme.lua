...
function M.setup()
	...
	theme.highlights = {
		...
		FloatBorder = { fg = c.popup_border, bg = c.none }, -- Float Border.
		...
		PmenuSel = {bg = c.bg_cursor}, -- Popup menu: selected item.
		...
		WinBar = { fg = c.popup_border, bg = c.bg_main }, -- Window bar.
		...
		LazyGitBorder = { fg = c.popup_border, bg = c.none },
		...
		LspInfoBorder = { fg = c.popup_border, bg = c.bg_popup },

		BlinkCmpMenu = { fg = c.comment, bg = c.bg_popup },
		BlinkCmpMenuBorder = { fg = c.popup_border, bg = c.bg_popup },
		BlinkCmpDocBorder = { fg = c.popup_border, bg = c.bg_popup },
		BlinkCmpDocSeparator = { fg = c.border, bg = c.bg_popup },
		BlinkCmpSignatureHelp = { fg = c.none, bg = c.bg_popup },
		BlinkCmpSignatureHelpBorder = { fg = c.popup_border, bg = c.bg_popup },
		...
		FzfLuaBorder = { fg = c.popup_border, bg = bg_main },
