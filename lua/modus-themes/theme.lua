...
function M.setup()
	...
	theme.highlights = {
		...
		NormalFloat = { fg = c.comment, bg = c.bg_main }, -- Float Window.
		FloatBorder = { fg = c.border, bg = c.bg_main }, -- Float Border.
		FloatTitle = { fg = c.none, bg = c.bg_main }, -- Float Title.
		...
		Pmenu = { fg = c.none, bg = c.bg_main }, -- Popup menu: normal item.
