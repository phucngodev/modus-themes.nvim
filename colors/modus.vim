...
" Force light theme (modus_operandi) only
...
function! s:apply_highlights(c, bg_main, bg_inactive, fg_inactive)
  let c.bg_sidebar = c.bg_dim
  let c.fg_sidebar = c.fg_main
  ...
  call s:hi("NormalNC", fg_inactive, bg_inactive, "", "")
  call s:hi("NormalSB", a:c.fg_sidebar, a:c.bg_sidebar, "", "")
  call s:hi("NormalFloat", a:c.comment, a:c.bg_popup, "", "")
  call s:hi("FloatBorder", a:c.comment, a:c.none, "", "")
  call s:hi("FloatTitle", a:c.none, a:c.bg_popup, "", "")
  ...
  call s:hi("lCursor", "", "", "", "link Cursor")
  call s:hi("CursorIM", "", "", "", "link Cursor")
  ...
  call s:hi("Menu", "", "", "", "link Pmenu")
  call s:hi("Scrollbar", "", "", "", "link PmenuSbar")
  call s:hi("Directory", a:c.blue, "", "", "")
  call s:hi("Title", a:c.fg_alt, "", "bold", "")
  call s:hi("Visual", a:c.fg_main, a:c.visual, "", "")
  call s:hi("VisualNOS", "", "", "", "link Visual")
  call s:hi("WildMenu", a:c.fg_main, a:c.visual, "", "")
  call s:hi("Whitespace", "", "", "", "link NonText")
  call s:hi("StatusLine", a:c.fg_tab_other, a:c.bg_statusline, "", "")
  call s:hi("StatusLineNC", a:c.fg_tab_other, a:c.bg_statusline, "", "")
  ...
  call s:hi("WinBarNC", "", "", "", "link TabLine")
  ...
  call s:hi("VertSplit", a:c.border, a:c.none, "", "")
  call s:hi("WinSeparator", a:c.border, a:c.bg_main, "", "")
  ...
  " ALE highlights
  call s:hi("ALEErrorSign", a:c.error, a:c.bg_main, "bold", "")
  call s:hi("ALEWarningSign", a:c.warning, a:c.bg_main, "bold", "")
