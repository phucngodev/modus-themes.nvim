...
function! s:apply_highlights(c, bg_main, bg_inactive, fg_inactive)
  ...
  call s:hi("SpecialKey", a:c.nontext, "", "", "")
  ...
  call s:hi("PmenuSel", a:c.comment, a:c.bg_cursor, "", "")
  call s:hi("PmenuSbar", a:c.none, a:c.bg_popup, "", "")
  ...
  call s:hi("WildMenu", a:c.fg_main, a:c.bg_popup, "", "")
  ...
  call s:hi("LspPopup", a:c.comment, a:c.bg_main, "", "")
  call s:hi("LspPopupBorder", a:c.border, a:c.bg_main, "", "")
  call s:hi("LspCompletionPopupBorder", a:c.border, a:c.bg_main, "", "")
  ...
  call s:hi("LspDiagSignErrorText", a:c.error, a:c.bg_main, "bold", "")
  call s:hi("LspDiagSignWarningText", a:c.warning, a:c.bg_main, "bold", "")
  call s:hi("LspDiagSignInfoText", a:c.info, a:c.bg_main, "bold", "")
  call s:hi("LspDiagSignHintText", a:c.hint, a:c.bg_main, "bold", "")
